# Based on https://github.com/Project-MONAI/MONAI/blob/027947bf91ff0dfac94f472ed1855cd49e3feb8d/monai/networks/nets/unetr.py

import torch
import torch.nn as nn
from einops import rearrange

from modules import TranspConv3DBlock, SkipBlock, Conv3DBlock
from volume_embedding import Embeddings3D
...
class TransUNet(nn.Module):
    def __init__(self, img_shape=(96, 96, 96), input_dim=1, output_dim=2,
                 embed_dim=768, patch_size=16, num_heads=12, dropout=0.25,
        ...
        self.z3_blue_conv = SkipBlock(in_planes=embed_dim, out_planes=base_filters * 2, layers=3)

        self.z6_blue_conv = SkipBlock(in_planes=embed_dim, out_planes=base_filters * 4, layers=2)

        self.z9_blue_conv = SkipBlock(in_planes=embed_dim, out_planes=base_filters * 8, layers=1)
